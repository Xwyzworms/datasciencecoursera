...
> dim(my_vector) <- C(4,5)
Error in C(4, 5) : object not interpretable as a factor
> dim(my_vector) <- c(4,5)
...
> columns <- "Patient","age","weight","bp","rating","test"
Error: unexpected ',' in "columns <- "Patient","
> columns <- c("Patient","age","weight","bp","rating","test")

| Not exactly. Give it another go. Or, type info() for more options.

| Make sure all of the names are lowercase, surrounded by double quotes, and separated with commas. Don't forget to use
| the c() function.
...
> columns <- c(age","weight","bp","rating","test")
Error: unexpected string constant in "columns <- c(age",""
> columns <- c("age","weight","bp","rating","test")
...
> colnames() <- cnames
Error in colnames() <- cnames : invalid (NULL) left side of assignment
